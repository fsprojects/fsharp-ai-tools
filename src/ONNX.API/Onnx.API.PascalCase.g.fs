...
type Onnx() =
    ...
    static member EyeLike<'a>(input: Tensor<int>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<int>, ?k: int64) =
        execNodeCheck<int> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<double>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<double>, ?k: int64) =
        execNodeCheck<double> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<int8>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<int8>, ?k: int64) =
        execNodeCheck<int8> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<int16>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<int16>, ?k: int64) =
        execNodeCheck<int16> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<uint8>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<uint8>, ?k: int64) =
        execNodeCheck<uint8> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<uint32>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<uint32>, ?k: int64) =
        execNodeCheck<uint32> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<uint16>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<uint16>, ?k: int64) =
        execNodeCheck<uint16> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<float32>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<float32>, ?k: int64) =
        execNodeCheck<float32> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<int64>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<int64>, ?k: int64) =
        execNodeCheck<int64> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<bool>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<bool>, ?k: int64) =
        execNodeCheck<bool> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<uint64>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<uint64>, ?k: int64) =
        execNodeCheck<uint64> "EyeLike" [|MV.mv(1,input)|] [|6L; 11L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    ...
    static member RandomUniformLike<'a>(input: Tensor<int>, ?high: float32, ?low: float32, ?seed: float32) =
        execNodeCheck<'a> "RandomUniformLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("high", high, 1.0f); Attr.float("low", low, 0.0f); Attr.float("seed", seed)|] |> Array.choose id)
    static member RandomUniformLike(input: Tensor<int>, ?high: float32, ?low: float32, ?seed: float32) =
        execNodeCheck<int> "RandomUniformLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("high", high, 1.0f); Attr.float("low", low, 0.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomUniformLike(input: Tensor<double>, ?high: float32, ?low: float32, ?seed: float32) =
        execNodeCheck<double> "RandomUniformLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("high", high, 1.0f); Attr.float("low", low, 0.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomUniformLike(input: Tensor<int8>, ?high: float32, ?low: float32, ?seed: float32) =
        execNodeCheck<int8> "RandomUniformLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("high", high, 1.0f); Attr.float("low", low, 0.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomUniformLike(input: Tensor<string>, ?high: float32, ?low: float32, ?seed: float32) =
        execNodeCheck<string> "RandomUniformLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("high", high, 1.0f); Attr.float("low", low, 0.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomUniformLike(input: Tensor<Complex>, ?high: float32, ?low: float32, ?seed: float32) =
        execNodeCheck<Complex> "RandomUniformLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("high", high, 1.0f); Attr.float("low", low, 0.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomUniformLike(input: Tensor<int16>, ?high: float32, ?low: float32, ?seed: float32) =
        execNodeCheck<int16> "RandomUniformLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("high", high, 1.0f); Attr.float("low", low, 0.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomUniformLike(input: Tensor<uint8>, ?high: float32, ?low: float32, ?seed: float32) =
        execNodeCheck<uint8> "RandomUniformLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("high", high, 1.0f); Attr.float("low", low, 0.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomUniformLike(input: Tensor<uint32>, ?high: float32, ?low: float32, ?seed: float32) =
        execNodeCheck<uint32> "RandomUniformLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("high", high, 1.0f); Attr.float("low", low, 0.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomUniformLike(input: Tensor<uint16>, ?high: float32, ?low: float32, ?seed: float32) =
        execNodeCheck<uint16> "RandomUniformLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("high", high, 1.0f); Attr.float("low", low, 0.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomUniformLike(input: Tensor<float32>, ?high: float32, ?low: float32, ?seed: float32) =
        execNodeCheck<float32> "RandomUniformLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("high", high, 1.0f); Attr.float("low", low, 0.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomUniformLike(input: Tensor<int64>, ?high: float32, ?low: float32, ?seed: float32) =
        execNodeCheck<int64> "RandomUniformLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("high", high, 1.0f); Attr.float("low", low, 0.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomUniformLike(input: Tensor<bool>, ?high: float32, ?low: float32, ?seed: float32) =
        execNodeCheck<bool> "RandomUniformLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("high", high, 1.0f); Attr.float("low", low, 0.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomUniformLike(input: Tensor<uint64>, ?high: float32, ?low: float32, ?seed: float32) =
        execNodeCheck<uint64> "RandomUniformLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("high", high, 1.0f); Attr.float("low", low, 0.0f); Attr.float("seed", seed)|] |> Array.choose id)
    static member RandomNormalLike<'a>(input: Tensor<int>, ?mean: float32, ?scale: float32, ?seed: float32) =
        execNodeCheck<'a> "RandomNormalLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("mean", mean, 0.0f); Attr.float("scale", scale, 1.0f); Attr.float("seed", seed)|] |> Array.choose id)
    static member RandomNormalLike(input: Tensor<int>, ?mean: float32, ?scale: float32, ?seed: float32) =
        execNodeCheck<int> "RandomNormalLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("mean", mean, 0.0f); Attr.float("scale", scale, 1.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomNormalLike(input: Tensor<double>, ?mean: float32, ?scale: float32, ?seed: float32) =
        execNodeCheck<double> "RandomNormalLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("mean", mean, 0.0f); Attr.float("scale", scale, 1.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomNormalLike(input: Tensor<int8>, ?mean: float32, ?scale: float32, ?seed: float32) =
        execNodeCheck<int8> "RandomNormalLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("mean", mean, 0.0f); Attr.float("scale", scale, 1.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomNormalLike(input: Tensor<string>, ?mean: float32, ?scale: float32, ?seed: float32) =
        execNodeCheck<string> "RandomNormalLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("mean", mean, 0.0f); Attr.float("scale", scale, 1.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomNormalLike(input: Tensor<Complex>, ?mean: float32, ?scale: float32, ?seed: float32) =
        execNodeCheck<Complex> "RandomNormalLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("mean", mean, 0.0f); Attr.float("scale", scale, 1.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomNormalLike(input: Tensor<int16>, ?mean: float32, ?scale: float32, ?seed: float32) =
        execNodeCheck<int16> "RandomNormalLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("mean", mean, 0.0f); Attr.float("scale", scale, 1.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomNormalLike(input: Tensor<uint8>, ?mean: float32, ?scale: float32, ?seed: float32) =
        execNodeCheck<uint8> "RandomNormalLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("mean", mean, 0.0f); Attr.float("scale", scale, 1.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomNormalLike(input: Tensor<uint32>, ?mean: float32, ?scale: float32, ?seed: float32) =
        execNodeCheck<uint32> "RandomNormalLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("mean", mean, 0.0f); Attr.float("scale", scale, 1.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomNormalLike(input: Tensor<uint16>, ?mean: float32, ?scale: float32, ?seed: float32) =
        execNodeCheck<uint16> "RandomNormalLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("mean", mean, 0.0f); Attr.float("scale", scale, 1.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomNormalLike(input: Tensor<float32>, ?mean: float32, ?scale: float32, ?seed: float32) =
        execNodeCheck<float32> "RandomNormalLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("mean", mean, 0.0f); Attr.float("scale", scale, 1.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomNormalLike(input: Tensor<int64>, ?mean: float32, ?scale: float32, ?seed: float32) =
        execNodeCheck<int64> "RandomNormalLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("mean", mean, 0.0f); Attr.float("scale", scale, 1.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomNormalLike(input: Tensor<bool>, ?mean: float32, ?scale: float32, ?seed: float32) =
        execNodeCheck<bool> "RandomNormalLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("mean", mean, 0.0f); Attr.float("scale", scale, 1.0f); Attr.float("seed", seed)|] |> Array.choose id)
    ...
    static member RandomNormalLike(input: Tensor<uint64>, ?mean: float32, ?scale: float32, ?seed: float32) =
        execNodeCheck<uint64> "RandomNormalLike" [|MV.mv(1,input)|] [|11L; 1L|] ([|Attr.float("mean", mean, 0.0f); Attr.float("scale", scale, 1.0f); Attr.float("seed", seed)|] |> Array.choose id)
    static member RandomNormal<'a>(shape: int64[], ?mean: float32, ?scale: float32, ?seed: float32) =
        execNodeCheck<'a> "RandomNormal" [||] [|11L; 1L|] ([|Attr.ints("shape", shape); Attr.float("mean", mean, 0.0f); Attr.float("scale", scale, 1.0f); Attr.float("seed", seed)|] |> Array.choose id)
    static member RandomUniform<'a>(shape: int64[], ?high: float32, ?low: float32, ?seed: float32) =
        execNodeCheck<'a> "RandomUniform" [||] [|11L; 1L|] ([|Attr.ints("shape", shape); Attr.float("high", high, 1.0f); Attr.float("low", low, 0.0f); Attr.float("seed", seed)|] |> Array.choose id)
    static member Cast<'a>(input: Tensor<int>) =
        execNodeCheck<'a> "Cast" [|MV.mv(1,input)|] [|6L; 11L; 8L; 3L; 5L; 2L; 12L; 4L; 1L; 7L; 9L; 13L|] [||]
